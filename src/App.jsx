        ...
        <div className="grid gap-6 md:grid-cols-4 md:grid-rows-none bg-opacity-20">
          <div className="p-6 xl:p-10 bg-violet rounded-xl lg:col-span-2  relative">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4 relative z-30">
                <p className="text-wheat ">Daniel Clifford</p>
                <p className="text-wheat text-xs opacity-50">Verified Graduate</p>
              </div>
            </div>
            <h1 className=" mt-5 text-wheat font-semibold text-xl relative z-30">
              I received a job offer mid-course, and the subjects I learned were
              current, if not more so, in the company I joined. I honestly feel
              I got every penny’s worth.
            </h1>
            <p className=" text-wheat text-[13px] opacity-70 mt-5">
          ...
          <div className="p-6  bg-darkBlue rounded-xl ">
            <div className="flex items-center">
              ...
              />
              <div className="ml-4">
                <p className="text-wheat ">Jonathan Walters</p>
                <p className="text-wheat text-xs opacity-50">Verified Graduate</p>
              </div>
            </div>
            <h1 className="mt-5 text-wheat font-semibold text-xl">
              The team was very supportive and kept me motivated
            </h1>
            <p className=" text-wheat opacity-70 mt-5 text-[13px]">
          ...
          <div className="p-6  bg-wheat rounded-xl ">
            <div className="flex items-center">
              ...
              />
              <div className="ml-4">
                <p className="text-white ">Jeanette Harmon</p>
          ...
          <div className="p-6 bg-blackBlue rounded-xl  lg:col-span-2">
            <div className="flex items-center">
              ...
              />
              <div className="ml-4">
                <p className=" text-wheat">Patrick Abrams</p>
                <p className="text-wheat text-xs opacity-50">Verified Graduate</p>
              </div>
            </div>
            <h1 className="mt-5 text-wheat font-semibold text-xl">
          ...
          <div className="p-6  bg-wheat rounded-xl  lg:col-start-4 lg:row-span-2 lg:row-start-1">
            <div className="flex items-center">
              ...
              />
              <div className="ml-4">
                <p className=" text-white">Kira Whittle</p>
                <p className="text-white text-xs opacity-50">Verified Graduate</p>
              </div>
            </div>
            <h1 className="mt-5 font-semibold text-xl">
